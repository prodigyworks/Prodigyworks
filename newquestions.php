...
<div class='questions'>
	    	...
	    	<?php
				...
				if ($result) {
					while (($member = mysql_fetch_assoc($result))) {
						...
						echo "<td><a href='viewquestion.php?id=" . $member['id'] . "'><img title='View question' src='images/view.png' /></a></td>";
						echo "<td><a href='publishquestion.php?id=" . $member['id'] . "'><img title='Publish question' src='images/publish.png' /></a></td>";
	...
	<?php
		if ($prevpage) {
			echo "<img src='images/previouspage.png' onclick='window.location.href = \"newquestions.php?from=" . ($fromrow - $pagesize) . "&to=" . ($torow - $pagesize) . "\"' />";
		}
		
		if ($nextpage) {
			echo "<img src='images/nextpage.png' onclick='window.location.href = \"newquestions.php?from=" . ($fromrow + $pagesize) . "&to=" . ($torow + $pagesize) . "\"' />";
		}
	?>
</div>
<?php
